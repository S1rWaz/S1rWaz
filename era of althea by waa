...
local lib = loadstring(game:HttpGet('https://raw.githubusercontent.com/S1rWaz/S1rWaz/main/...', true))()
local window = lib:CreateWindow('Waa hub beta')
window:AddLabel({text = "ไอหว้าสุดหล่อ"})
...
window2:AddBind({text = 'fly', hold = false, key = "P", callback = function()
    if not legitmode then
